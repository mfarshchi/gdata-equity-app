    ...
    public PageResponse<UserDTO> findAll(PageRequestByExample<UserDTO> req) {
        ...
        if (user != null) {
            ExampleMatcher matcher = ExampleMatcher.matching() //
                    ...
                    .withMatcher(User_.password.getName(), match -> match.ignoreCase().startsWith())
                    .withMatcher(User_.email.getName(), match -> match.ignoreCase().startsWith())
                    .withMatcher(User_.civility.getName(), match -> match.ignoreCase().startsWith())
                    .withMatcher(User_.countryCode.getName(), match -> match.ignoreCase().startsWith())
